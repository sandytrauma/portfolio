            ...
            {selectedProject ? (
              <>
                <iframe
                  ...
                  className="w-full h-full rounded-2xl shadow-lg border-4 border-gray-700 bg-white"
                />
                <button
                  onClick={handleClosePreview}
                  className="absolute top-6 right-6 p-2 rounded-full bg-red-500 hover:bg-red-600 transition-colors duration-200 text-white shadow-lg focus:outline-none"
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {jobProfileTabs.map((tab) => (
                  <motion.button
                    ...
                    className={`p-3 rounded-xl font-medium transition-all duration-300 ease-in-out ${
